...
from k_calculations import get_best_k
...
points = get_points_by_mouse(POINTS_COUNT, AX, AY)

CLUSTERS_COUNT = get_best_k(points)
...
animation.save(filename="animations/animation_mouse_generated.gif", writer="pillow")
